...
/**
 * @dev Complete top-level interface for gaTokens, implemented by the
 *      GATokenBase contract. See GATokenBase.sol for further documentation.
 */
interface GAToken is GToken
{
	// pure functions
