 ...
 *      It is therefore a public library shared by all gaToken Type 2 contracts and
 *      needs to be published alongside them. See GATokenType2.sol for further
 *      documentation.
 */
library GADelegatedReserveManager
{
	 ...
	 * @param _reserveToken The ERC-20 token address of the reserve token (aToken).
	 * @param _borrowToken The ERC-20 token address of the borrow token (aToken).
	 ...
	 *      This library converts the growthToken into the underlyingToken
	 ...
	 *      if necessary. It will attempt to incorporate the profits from the
	 *      underlying growth investment and adjust the collateralization
